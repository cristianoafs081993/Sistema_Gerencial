...
- Para o terceirizado de refeitório, vínculos com `contrato_id` são exibidos como contratos autorizados em `/requisicao-compra`; eles são informativos e não liberam os empenhos do contrato sem vínculos diretos por `empenho_id`.
