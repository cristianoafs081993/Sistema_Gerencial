...
- Consulta financeira (extensao 1.9.31): `SuapExtensionProcessInfo` repassa o mesmo cliente efemero autenticado a toda a cadeia de processos, empenhos, contratos, contratos API e liquidacoes. Nenhuma dessas consultas usa o cliente Supabase global do SIAGES. A operacao tem limite de 30 segundos e devolve erro com nova tentativa ao painel em vez de manter carregamento indefinido.
