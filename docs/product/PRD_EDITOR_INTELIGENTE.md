...
- **Headless UI**: Toolbar customizada com design system do GovAnalytics.
...
- Os anexos auxiliares entram apenas como snippets com nome da fonte, pagina/aba/linhas/bloco quando disponivel, categoria e trecho extraido, apoiando a geracao por secao e o rascunho final de forma pontual. Eles nao alimentam sugestoes automaticas do questionario e nao devem definir foco, escopo ou narrativa principal do ETP.
...
- **Estética**: Manter o conceito de "GovAnalytics" (Glassmorphism, sombreamento `shadow-lifted`, paleta slate/blue).
