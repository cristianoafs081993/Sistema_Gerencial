...
| Retencoes FD-Reinf | `RetencoesFdReinfDesign.tsx` | CSV | `retencoesEfdReinfImportService.ts` | `retencoes_efd_reinf` | UI aceita XLSX, parser atual nao; alertas tratados podem ser marcados em `correcao_realizada` e deixam as pendencias abertas |
