...
- Ao mudar para `enviada_fornecedor`, o valor da requisição passa a ser **descontado do saldo disponível do empenho exibido no módulo de Requisição de Compra**, garantindo transparência operacional com exibição estruturada: **Saldo Oficial (SIAFI)**, **(-) Enviado ao Fornecedor** e **(=) Saldo Disponível Efetivo**.
