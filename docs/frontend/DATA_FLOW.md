...
- no [Dashboard.tsx](/C:/Users/crist/OneDrive/Desktop/Obsidian/01%20-%20Projetos/Apps/Sistema_Gerencial/src/pages/Dashboard.tsx), origens de recursos externos que não integram o planejamento/POA (como `230446` - PNAE/FNDE) são excluídas dos somatórios, gráficos e filtros do Dashboard (`EXCLUDED_DASHBOARD_ORIGENS`), garantindo que recursos externos não distorçam a taxa de execução orçamentária do planejamento do campus. As demais páginas do sistema (`Descentralizacoes.tsx`, `Empenhos.tsx`, etc.) mantêm a visibilidade completa dessas origens.
