...
describe('documentos individuais do processo SUAP', () => {
  ...
  it('extrai apenas links diretos originais e preserva a ordem dos documentos', () => {
    ...
    expect(manifest.map((document) => document.classification)).toEqual(['included', 'excluded']);
