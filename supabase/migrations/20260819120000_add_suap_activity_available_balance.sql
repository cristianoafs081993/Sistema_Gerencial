-- Persiste o saldo oficial da coluna "Saldo disponível para empenho da atividade"
-- capturada no Plano 8 do SUAP pela sincronização.

ALTER TABLE public.suap_plan_activity_snapshots
  ADD COLUMN IF NOT EXISTS saldo_disponivel numeric(16,2);
